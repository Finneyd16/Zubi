    ...
    <section className=" w-full px-6 sm:px-10 lg:px-20 py-20">
      ...
      <div className="flex flex-col lg:flex-row items-start justify-between gap-10 mb-16 ">
        ...
        <div className="flex-1 " >
          <img src="Light Effect.png" className="absolute top-365 left-95 " /> 
          {/* EVADE Logo */}
          ...
          {/* Introducing label */}
          <p className="text-blue-400 text-sm font-medium mb-6 pt-2">Introducing EVADE</p>
...
<div className="relative bg-white/5 border border-white/10 rounded-2xl p-8 overflow-hidden shadow-[0_0_30px_rgba(59,130,246,0.1)] hover:shadow-[0_0_40px_rgba(59,130,246,0.2)] transition-shadow">
  <h3 className="text-white font-bold text-2xl lg:text-4xl mb-4">The Problem</h3>
  <p className="text-gray-400 text-sm leading-relaxed max-w-[470px]">
    ...
    data is lost or disputed. Insurers battle over claims. Families wait in the
    dark.
  </p>
  {/* Watermark */}
  <span 
...
{/* Our Mission */}
<div className="relative bg-white/5 border border-white/10 rounded-2xl p-8 overflow-hidden shadow-[0_0_30px_rgba(59,130,246,0.1)] hover:shadow-[0_0_40px_rgba(59,130,246,0.2)] transition-shadow">
  <h3 className="text-white font-bold text-2xl lg:text-4xl mb-4">Our Mission</h3>
